 ...
 */
function payAction1(proid,id,addid) {
    ...
    $("#buy_now").on('click',function() {
        ...
        alert("支付发起中，请稍后");
        $.ajax({
            url: "/Mobile_web/insertOrder?sizeId=" +id + "&addressId=" + addid + "&proId=" + proid,
            type: "get",
            success: function (data) {
                // var response = JSON.parse(data);
            alert(data.data)
            window.location.href="/Mobile_web/myorders"
            }
                    ...
                    success: function (data) {
                        ...
                        wx.ready(function () {
                            wx.chooseWXPay({
                                ...
                                nonceStr: response.noncestr, // 支付签名随机串，不长于
																// 32 位
